...
def run_once(
    ...
    trainer = PPOTrainer(
        PPOTrainConfig(
            ...
            use_edge_gate=bool(training_config.get("use_edge_gate", False)),
            edge_gate_margin=float(training_config.get("edge_gate_margin", 1.25)),
            edge_gate_min_safety=float(training_config.get("edge_gate_min_safety", 0.15)),
            edge_gate_push_penalty=float(training_config.get("edge_gate_push_penalty", 2.0)),
            edge_gate_hidden_size=int(training_config.get("edge_gate_hidden_size", 16)),
